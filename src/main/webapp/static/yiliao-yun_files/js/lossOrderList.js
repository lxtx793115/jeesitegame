...
function detail(id,no,create_name,create_date,price){
	  ...
	  location.href=Window.ctx+"/../cStoreOrderController/reportLossOrderListDetail.do?orderId="+id+"&no="+no+"&create_name="+create_name+"&create_date="+create_date+"&price="+price;
}
