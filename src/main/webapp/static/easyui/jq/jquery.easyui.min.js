...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:""};
})(jQuery);
(function($){
function _92(_93){
var _94=$(_93);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"不能为空！",invalidMessage:null,rules:{email:{validator:function(_38b){
...
},message:"请输入正确的邮件格式！"},url:{validator:function(_38c){
...
},message:"{0} 到 {1} 位！"},remote:{validator:function(_38f,_390){
var data={};
data[_390[1]]=_38f;
