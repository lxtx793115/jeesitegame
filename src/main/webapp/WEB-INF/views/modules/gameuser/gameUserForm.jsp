...
<body>
	...
	<form:form id="inputForm" modelAttribute="gameUser" action="${ctx}/gameuser/gameUser/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">注册IP地区：</label>
			<div class="controls">
				<form:input path="registerIpArea" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">登录IP地区：</label>
			<div class="controls">
				<form:input path="loginIpArea" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">登录环境：</label>
			<div class="controls">
				<form:input path="loginEnvironment" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="registerTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${gameUser.registerTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="loginTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${gameUser.loginTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
				<input id="status" name="status" type="hidden" value="0" htmlEscape="false" maxlength="1" class="input-xlarge "/>
				<input id="fenghaostatus" name="fenghaostatus" type="hidden" value="0" htmlEscape="false" maxlength="1" class="input-xlarge "/>
				<input id="fengip" name="fengip" type="hidden" value="0" htmlEscape="false" maxlength="1" class="input-xlarge "/>
