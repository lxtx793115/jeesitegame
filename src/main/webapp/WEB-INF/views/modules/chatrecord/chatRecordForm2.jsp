...
<body>
	<ul class="nav nav-tabs">
		<li ><a href="${ctx}/chatrecord/chatRecordII/">客服聊天</a></li>
		<li class="active"><a href="${ctx}/chatrecord/chatRecordII/formII?id=${chatRecord.id}">聊天记录管理<shiro:hasPermission name="chatrecord:chatRecordII:edit">${not empty chatRecord.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="chatrecord:chatRecord:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
