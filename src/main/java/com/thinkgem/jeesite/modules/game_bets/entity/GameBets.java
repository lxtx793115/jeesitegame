 ...
 */
package com.thinkgem.jeesite.modules.game_bets.entity;
 ...
 * @version 2018-05-03
 */
public class GameBets extends DataEntity<GameBets> {
	
	private static final long serialVersionUID = 1L;
	private String roomId;		// 房间id
	private String gameUserId;		// 游戏用户id
	private float money;		// 下注金额
	private float da;		// 大
	...
	public GameBets(String id){
		super(id);
	}

	@Length(min=1, max=64, message="房间id长度必须介于 1 和 64 之间")
	...
	@Length(min=1, max=64, message="游戏用户id长度必须介于 1 和 64 之间")
