...
public class SmsPianYunUtil {
    ...
    URISyntaxException {
	   ...
	   long tpl_id = 2110580;
	   String json=SmsPianYunUtil.tplSendSms(apikey, tpl_id, tpl_value,phone);
    ...
    URISyntaxException {
    	String apikey = "13898519a92d32e6844f36269ecb1c7e";
	  String mobile = "18589144111";
	  String text = "您的验证码是";
	  System.out.println(SmsPianYunUtil.sendSms(apikey, text, mobile));
    }
    public static void main4(String[] args) throws IOException,
        URISyntaxException {
            ...
            /**************** 查账户信息调用示例 *****************/
            //System.out.println(SmsPianYunUtil.getUserInfo(apikey));
            /**************** 使用智能匹配模板接口发短信(推荐) *****************/
            ...
            long tpl_id = 2110580;
            //设置对应的模板变量值
            String tpl_value2 = URLEncoder.encode("#code#", ENCODING) + "=" +
                URLEncoder.encode("1234", ENCODING) + "&" + URLEncoder.encode(
                    "#code#", ENCODING) + "=" + URLEncoder.encode("云片网",
                    ENCODING);
            String code = "12341";
            String tpl_value= URLEncoder.encode("#code#", ENCODING) + "=" +
                    URLEncoder.encode(code,ENCODING);
            //模板发送的调用示例 //替换模板
            System.out.println("替换模板"+tpl_value);
            /**************** 使用接口发语音验证码 *****************/
           
            //System.out.println(JavaSmsApi.sendVoice(apikey, mobile ,code));
            String json=SmsPianYunUtil.tplSendSms(apikey, tpl_id, tpl_value,mobile);
            System.out.println(json);
            /**************** 使用接口绑定主被叫号码 *****************/
            String from = "+86130xxxxxxxx";
            String to = "+86131xxxxxxxx";
            //Integer duration = 30 * 60; // 绑定30分钟
            Integer duration = 1 * 10; // 绑定30分钟
